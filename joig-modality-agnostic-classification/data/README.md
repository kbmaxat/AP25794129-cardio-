...
Place local data below `data/raw/`; this directory is ignored by Git. The internal dataset can be added later by appending manifest rows without changing the code.
